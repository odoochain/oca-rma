...
class TestRMA(common.TransactionCase):
    def setUp(self):
        ...
        self.template_missing = self.env.ref('pl_rma.template_missing_item')
        self.template_return = self.env.ref('pl_rma.template_picking_return')
        self.template_rtv = self.env.ref('pl_rma.template_rtv')
    ...
    def test_20_picking_rma(self):
        ...
        location = self.env.ref('stock.stock_location_locations')
